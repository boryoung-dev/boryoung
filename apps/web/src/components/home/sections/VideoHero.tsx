...
import type { CtaButtonItem, VideoHeroConfig } from "./_shared/types";
...
/** 비디오 히어로 섹션 — 자동재생 배경 영상 + 헤딩 + CTA */
export function VideoHero({ curation }: { curation: CurationSection }) {
  const cfg = (curation.displayConfig || {}) as VideoHeroConfig;
  ...
  return (
    <SectionContainer
      style={style}
      minHeight={HEIGHT_MAP[heightPreset]}
    ...
    >
      ...
      <div
        className="relative w-full max-w-[1200px] mx-auto px-4 md:px-6"
        style={{ zIndex: 2 }}
      >
        <SectionHeading
