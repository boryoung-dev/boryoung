...
export function CategoryTabsSection(props: {
  ...
  return (
    <section className="bg-[color:var(--bg)] py-20">
      <div className="mx-auto max-w-[1200px] px-6">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    active === tab.key
                      ...
                      : "bg-[color:var(--surface)] text-[color:var(--fg)] ring-1 ring-[color:var(--border)] hover:bg-[color:var(--surface)]/80"
                  )}
                >
                  {tab.label}
                </button>
        ...
        <div className="relative overflow-hidden rounded-[28px] bg-[#111113] py-10">
