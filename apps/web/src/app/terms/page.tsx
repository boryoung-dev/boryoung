...
export const metadata: Metadata = {
  title: "이용약관",
  description: "보령항공여행사의 서비스 이용약관입니다.",
  alternates: {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-[color:var(--fg)] mb-8">이용약관</h1>

        <div className="prose prose-lg max-w-none text-[color:var(--fg)] space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제1조 (목적)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제2조 (정의)</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제3조 (약관의 명시 및 변경)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제4조 (여행 계약의 체결)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제5조 (예약금 및 잔금)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제6조 (계약의 해제 및 환불)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제7조 (회사의 책임)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제8조 (고객의 의무)</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[color:var(--fg)] mb-4">제9조 (분쟁 해결)</h2>
            <p>
