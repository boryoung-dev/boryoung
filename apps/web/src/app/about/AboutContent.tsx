                ...
                <div>
                  ...
                  <div className="space-y-5">
                    {[
                      ...
                      { year: "2025", desc: "대한항공, 일본항공 등 국내 및 해외국적기 항공사 파트너쉽 완료" },
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-0">
              {[
                ...
                "대기업 MICE 행사 경험 다수 (트릿지, 신한그룹, 기업은행 등)",
                "2022년부터 학군단 해외군사문화 탐방 30건 이상 수행",
                "해외 현지와의 직접적인 거래로 비용절감 등",
                "SBS골프방송, 신문, 블로그 광고 등 고객 유지를 위한 지속적인 광고비 투자",
              ].map((item, i) => (
